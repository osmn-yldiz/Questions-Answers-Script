                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row text-center mt-4">
                                <div class="col p-2">
                                    <h4 class="mb-1 line-height-5">{{ \App\Models\Questions::where('userId',$data[0]['id'])->count() }}</h4>
                                    <small class="mb-0 font-weight-bold">Soru</small>
                                </div>
                                <div class="col p-2">
                                    <h4 class="mb-1 line-height-5">{{ \App\Models\Comments::where('userId',$data[0]['id'])->count() }}</h4>
                                    <small class="mb-0 font-weight-bold">Cevap</small>
                                </div>
                                <div class="col p-2">
                                    <h4 class="mb-1 line-height-5">{{\App\Models\Comments::where('userId',$data[0]['id'])->where('isCorrect',1)->count()}}</h4>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    @foreach($questions as $k => $v)
                                        <tr>
                                            <td>
                                                <span
                                                    class="float-right font-weight-bold">{{ \App\Helper\mHelper::time_ago($v['created_at']) }}</span>
